🚨 Scam City — Real-Time Voice Phishing Detection

Real-time scam risk detection for phone calls, powered by AI.

Scam City is an experimental research project aimed at detecting voice phishing (보이스피싱) in real time.
